...
namespace Profit.Integrator.Storage
{
    ...
    public partial class MonitoringDevice : IEquatable<MonitoringDevice>
    {
        ...
        private static readonly IEqualityComparer<MonitoringDevice> _equalityComparer = ComparerBuilder.GetEqualityComparer<MonitoringDevice>(c => c.Id);

        public bool Equals(MonitoringDevice? other)
        {
        ...
        {
            return Equals(obj as MonitoringDevice);
        }
        #endregion
    }
}
