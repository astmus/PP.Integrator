...
{
    [Table("bs_referencetypes")]
    public partial class BsReferencetype : IEquatable<BsReferencetype>
    {
        ...
        private static readonly IEqualityComparer<BsReferencetype> _equalityComparer = ComparerBuilder.GetEqualityComparer<BsReferencetype>(c => c.Id);

        public bool Equals(BsReferencetype? other)
        {
        ...
        {
            return Equals(obj as BsReferencetype);
        }
        #endregion
    }
}
