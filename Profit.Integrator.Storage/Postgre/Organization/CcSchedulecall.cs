...
{
    [Table("cc_schedulecall")]
    public partial class CcSchedulecall : IEquatable<CcSchedulecall>
    {
        ...
        [Column("result"   , DataType  = DataType.Int16    , DbType   = "smallint"                                                                              )] public short?    Result    { get; set; } // smallint
        ...
        private static readonly IEqualityComparer<CcSchedulecall> _equalityComparer = ComparerBuilder.GetEqualityComparer<CcSchedulecall>(c => c.Id);

        public bool Equals(CcSchedulecall? other)
        {
        ...
        {
            return Equals(obj as CcSchedulecall);
        }
        #endregion
    }
}
