...
namespace Profit.Integrator.Storage.Postgre.Organization
{
    public partial class OrganizationDataBase : DataConnection
    {
        ...
        public partial class Trustedapp : IEquatable<Trustedapp>
        {
            ...
            [Column("trustedappid", CanBeNull = false, DataType = DataType.NVarChar, DbType = "character varying(50)", Length = 50)] public string Trustedappid { get; set; } = null!; // character varying(50)
