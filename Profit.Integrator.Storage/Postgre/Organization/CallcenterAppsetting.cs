...
{
    [Table("callcenter_appsettings")]
    public partial class CallcenterAppsetting : IEquatable<CallcenterAppsetting>
    {
        ...
        private static readonly IEqualityComparer<CallcenterAppsetting> _equalityComparer = ComparerBuilder.GetEqualityComparer<CallcenterAppsetting>(c => c.Id);

        public bool Equals(CallcenterAppsetting? other)
        {
        ...
        {
            return Equals(obj as CallcenterAppsetting);
        }
        #endregion
    }
}
