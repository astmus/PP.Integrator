...
{
    [Table("console_userscontactsgroups")]
    public partial class ConsoleUserscontactsgroup : IEquatable<ConsoleUserscontactsgroup>
    {
        ...
        private static readonly IEqualityComparer<ConsoleUserscontactsgroup> _equalityComparer = ComparerBuilder.GetEqualityComparer<ConsoleUserscontactsgroup>(c => c.Id);

        public bool Equals(ConsoleUserscontactsgroup? other)
        {
        ...
        {
            return Equals(obj as ConsoleUserscontactsgroup);
        }
        #endregion
    }
}
