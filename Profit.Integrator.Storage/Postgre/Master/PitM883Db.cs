...
using LinqToDB;
using LinqToDB.Data;
using Profit.Integrator.Storage.Postgre.Master;
using System;
using System.Linq;
...
namespace Profit.Integrator.Storage
{
    ...
    /// 
    /// </summary>
    public partial class PitM883Db : DataConnection
    {
        public PitM883Db()
        {
            InitDataContext();
        ...
        public PitM883Db(string configuration)
            : base(configuration)
        {
            InitDataContext();
        }

        public PitM883Db(DataOptions<PitM883Db> options)
